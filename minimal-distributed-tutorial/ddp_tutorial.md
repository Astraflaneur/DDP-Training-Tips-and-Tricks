...
To demonstrate how to do this, I'll create an example that [trains on MNIST](https://github.com/astraflaneur/distributed_tutorial/blob/master/src/mnist.py), and then modify it to run on [multiple GPUs across multiple nodes](https://github.com/astraflaneur/distributed_tutorial/blob/master/src/mnist-distributed.py), and finally to also allow [mixed-precision training](https://github.com/astraflaneur/distributed_tutorial/blob/master/src/mnist-mixed.py). 
